...
with tab_tailor:
    ...
    st.caption("Shortcut: type just **Generic**, **Design**, **Manufacturing**, or **Tech** to generate a general-purpose resume for that track instead of tailoring to a real posting.")
